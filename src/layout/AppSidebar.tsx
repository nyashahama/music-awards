...
const othersItems: NavItem[] = [
  {
    ...
    name: "Reports",
    subItems: [
      { name: "Voting Analytics", path: "/analytics", pro: false },
      { name: "Export Data", path: "/export", pro: false },
    ],
  },
  {
    icon: <ListIcon />,
    name: "Nominees",
    subItems: [
      { name: "All Nominees", path: "/nominees", pro: false },
      { name: "Add Nominee", path: "/add-nominee", pro: false },
    ],
  },
  {
    icon: <BoxCubeIcon />,
    ...
    subItems: [
      { name: "Registered Voters", path: "/voters", pro: false },
      { name: "Voter Activity", path: "/voter-activity", pro: false },
    ],
  },
  {
    icon: <PlugInIcon />,
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Security", path: "/security", pro: false },
    ],
  },
];
